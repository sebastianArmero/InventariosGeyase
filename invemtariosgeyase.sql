...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-10-2020 a las 15:17:34
...
(14, 'yamileth ', 'melo', 'F', '123456', '2343223', 'yami@gmail.com', 'tarragona');
...
(58, 2, '2019-11-09 18:49:11'),
(59, 1, '2019-11-10 09:09:49'),
(60, 2, '2019-11-10 09:10:59'),
(61, 2, '2019-11-10 10:54:31'),
(62, 1, '2019-11-10 15:15:15'),
(63, 1, '2019-11-12 12:29:45'),
(64, 3, '2020-08-30 12:21:44');
...
(22, 'sebastian', 'armerosebas7@gmail.com', '12345');
...
(5, 'cilantro', 1000, 23),
(6, 'tomate', 456, 50),
(8, 'papel Carta', 1000, 1000),
(9, 'lapiceros ', 2500, 20),
(10, 'poker en lata', 3500, 500),
(11, 'pan', 500, 1000),
(12, 'agua', 2400, 5000),
(13, 'panela', 5000, 520);
...
--
ALTER TABLE `cliente`
  MODIFY `cod_cli` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `detallefactura`
--
ALTER TABLE `detallefactura`
  MODIFY `id_detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
...
--
ALTER TABLE `productos`
  MODIFY `cod_pro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
